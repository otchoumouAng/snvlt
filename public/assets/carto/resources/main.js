var serverPort = 'http://15.235.65.28:8082';
...
var transactWFS = function (mode, f) {
    ...
    $.ajax('http://15.235.65.28:8082/geoserver/wfs', {
        type: 'POST',
        dataType: 'xml',
        processData: false,
...
legendButton.innerHTML = '<h3>Légende</h3></br><img src="http://15.235.65.28:8082/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=DPIF:pef&STYLE=style_pef" style="margin-left:30px;">';
...
function zoomToFeature(featureName, layerName, attributeName) {
    ...
    var url = "http://15.235.65.28:8082/geoserver/DPIF/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=" + value_layer + "&CQL_FILTER=" + value_attribute + "+" + value_operator + "+'" + value_txt + "'&outputFormat=application/json"
    // console.log(url);
