    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('code_operateur', EntityType::class,[
                ...
                'attr'=>[
                    'class'=>'select2 role_user form-control form-control-sm bg-white'
                ],
            ...
            ->add('codeexploitant', EntityType::class,[
                ...
                'attr'=>[
                    'class'=>'select2 code_exploitant form-control form-control-sm bg-white'
                ],
            ...
            ->add('codeindustriel', EntityType::class,[
                ...
                'attr'=>[
                    'class'=>'select2 code_industriel form-control form-control-sm bg-white'
                ],
            ...
            ->add('code_dr', EntityType::class,[
                ...
                'attr'=>[
                    'class'=>'select2 code_dr form-control form-control-sm bg-white'
                ],
            ...
            ->add('code_cantonnement', EntityType::class,[
                ...
                'attr'=>[
                    'class'=>'select2 code_cantonnement form-control form-control-sm bg-white'
                ],
            ...
            ->add('code_ddef', EntityType::class,[
                ...
                'attr'=>[
                    'class'=>'select2 ddef form-control form-control-sm bg-white'
                ],
            ...
            ->add('code_poste_controle', EntityType::class,[
                ...
                'attr'=>[
                    'class'=>'select2 pf form-control form-control-sm bg-white'
                ],
            ...
            ->add('code_direction', EntityType::class,[
                ...
                'attr'=>[
                    'class'=>'select2 direction_minef form-control form-control-sm bg-white'
                ],
                'choice_label' => 'sigle',
                'multiple' => false,
                'expanded' => false,
            ...
            ->add('code_service', ChoiceType::class, [
                ...
                'required'=>false,
                'attr'=>[
                    'class'=>'select2 service_minef form-control form-control-sm bg-white'
                ]
            ])
            ...
            ->add('code_exportateur', EntityType::class,[
                ...
                'attr'=>[
                    'class'=>'select2 exportateur form-control form-control-sm bg-white'
                ],
