...
class ChangeLangueController extends AbstractController
{
    ...
    #[Route('/changeLocaleRegister', name: 'changeLocaleRegister')]
    public function changeLocaleRegister(RequestStack $requestStack, Request $request, EntityManagerInterface $em):Response
    {
        ...
        $requestStack->getSession()->set('_locale', $langue);
        return $this->redirectToRoute('register_new');
    }
