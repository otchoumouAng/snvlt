...
#[Route('/admin/reference/types-demandeur')]
class TypesDemandeurController extends BaseReferenceController
{
    public function __construct()
    {
        $this->entityClass = TypesDemandeur::class;
        $this->entityName = 'app_types_demandeur';
        $this->title = 'Types de Demandeur';
    }

    #[Route('/', name: 'app_types_demandeur_index', methods: ['GET'])]
    ...
    #[Route('/data', name: 'app_types_demandeur_data', methods: ['GET'])]
    public function getData(EntityManagerInterface $em): JsonResponse
    {
        return parent::getData($em);
    }

    #[Route('/save', name: 'app_types_demandeur_save', methods: ['POST'])]
    public function save(Request $request, EntityManagerInterface $em): JsonResponse
    {
        return parent::save($request, $em);
    }

    #[Route('/delete/{id}', name: 'app_types_demandeur_delete', methods: ['DELETE'])]
