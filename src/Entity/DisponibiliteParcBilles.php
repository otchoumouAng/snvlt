...
use App\Repository\DisponibiliteParcBillesRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'metier.disponibilite_parc_billes')]
#[ORM\Entity(repositoryClass: DisponibiliteParcBillesRepository::class)]
class DisponibiliteParcBilles
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
