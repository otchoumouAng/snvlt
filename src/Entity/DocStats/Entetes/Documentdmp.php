...
use App\Repository\DocStats\Entetes\DocumentdmpRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'metier.documentdmp')]
#[ORM\Entity(repositoryClass: DocumentdmpRepository::class)]
class Documentdmp
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'documentdmps')]
    ...
    private ?string $numero_docdmp = null;

    #[ORM\Column(type: Types::DATETIME_MUTABLE, nullable: true)]
    private ?\DateTimeInterface $delivre_docdmp = null;
    ...
    #[ORM\OneToMany(mappedBy: 'code_docdmp', targetEntity: Pagedmp::class)]
    ...
    public function getNumeroDocdmp(): ?string
    {
        return $this->numero_docdmp;
    }

    public function setNumeroDocdmp(?string $numero_docdmp): static
    {
        $this->numero_docdmp = $numero_docdmp;

        return $this;
    }

    public function getDelivreDocdmp(): ?\DateTimeInterface
    {
        return $this->delivre_docdmp;
    }

    public function setDelivreDocdmp(?\DateTimeInterface $delivre_docdmp): static
    {
        $this->delivre_docdmp = $delivre_docdmp;
    ...
    public function removePagedmp(Pagedmp $pagedmp): static
    {
        if ($this->pagedmps->removeElement($pagedmp)) {
            ...
            if ($pagedmp->getCodeDocdmp() === $this) {
                $pagedmp->setCodeDocdmp(null);
            }
        }
