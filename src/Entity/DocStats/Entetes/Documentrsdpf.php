...
use App\Repository\DocStats\Entetes\DocumentrsdpfRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'metier.documentrsdpf')]
#[ORM\Entity(repositoryClass: DocumentrsdpfRepository::class)]
class Documentrsdpf
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    private ?string $numero_docrsdpf = null;

    #[ORM\Column(type: Types::DATETIME_MUTABLE, nullable: true)]
    private ?\DateTimeInterface $delivre_docresdpf = null;

    #[ORM\ManyToOne(inversedBy: 'documentrsdpfs')]
    ...
    #[ORM\OneToMany(mappedBy: 'code_docrsdpf', targetEntity: Pagersdpf::class)]
    ...
    public function getNumeroDocrsdpf(): ?string
    {
        return $this->numero_docrsdpf;
    }

    public function setNumeroDocrsdpf(string $numero_docrsdpf): static
    {
        $this->numero_docrsdpf = $numero_docrsdpf;

        return $this;
    }

    public function getDelivreDocresdpf(): ?\DateTimeInterface
    {
        return $this->delivre_docresdpf;
    }

    public function setDelivreDocresdpf(?\DateTimeInterface $delivre_docresdpf): static
    {
        $this->delivre_docresdpf = $delivre_docresdpf;
    ...
    public function addPagersdpf(Pagersdpf $pagersdpf): static
    {
        if (!$this->pagersdpfs->contains($pagersdpf)) {
            ...
            $pagersdpf->setCodeDocrsdpf($this);
        }
    ...
    public function removePagersdpf(Pagersdpf $pagersdpf): static
    {
        if ($this->pagersdpfs->removeElement($pagersdpf)) {
            ...
            if ($pagersdpf->getCodeDocrsdpf() === $this) {
                $pagersdpf->setCodeDocrsdpf(null);
            }
        }
