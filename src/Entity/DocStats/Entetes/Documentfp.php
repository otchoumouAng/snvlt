...
use App\Repository\DocStats\Entetes\DocumentfpRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'metier.documentfp')]
#[ORM\Entity(repositoryClass: DocumentfpRepository::class)]
class Documentfp
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'documentfps')]
    private ?Usine $code_usin = null;
    ...
    private ?string $numero_docfp = null;

    #[ORM\Column(type: Types::DATETIME_MUTABLE, nullable: true)]
    private ?\DateTimeInterface $delivre_docfp = null;
    ...
    #[ORM\OneToMany(mappedBy: 'code_docfp', targetEntity: Pagefp::class)]
    ...
    public function getCodeUsin(): ?Usine
    {
        return $this->code_usin;
    }

    public function setCodeUsin(?Usine $code_usin): static
    {
        $this->code_usin = $code_usin;
    ...
    public function getNumeroDocfp(): ?string
    {
        return $this->numero_docfp;
    }

    public function setNumeroDocfp(string $numero_docfp): static
    {
        $this->numero_docfp = $numero_docfp;

        return $this;
    }

    public function getDelivreDocfp(): ?\DateTimeInterface
    {
        return $this->delivre_docfp;
    }

    public function setDelivreDocfp(?\DateTimeInterface $delivre_docfp): static
    {
        $this->delivre_docfp = $delivre_docfp;
    ...
    public function removePagefp(Pagefp $pagefp): static
    {
        if ($this->pagefps->removeElement($pagefp)) {
            ...
            if ($pagefp->getCodeDocfp() === $this) {
                $pagefp->setCodeDocfp(null);
            }
        }
