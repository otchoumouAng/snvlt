...
#[ORM\Table(name: 'metier.documentbth')]
#[ORM\Entity(repositoryClass: DocumentbthRepository::class)]
class Documentbth
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    private ?string $numero_docbth = null;

    #[ORM\Column(type: Types::DATETIME_MUTABLE, nullable: true)]
    private ?\DateTimeInterface $delivre_docbth = null;
    ...
    #[ORM\ManyToOne(inversedBy: 'documentbths')]
    ...
    #[ORM\OneToMany(mappedBy: 'code_docbth', targetEntity: Pagebth::class)]
    ...
    public function getNumeroDocbth(): ?string
    {
        return $this->numero_docbth;
    }

    public function setNumeroDocbth(string $numero_docbth): static
    {
        $this->numero_docbth = $numero_docbth;

        return $this;
    }

    public function getDelivreDocbth(): ?\DateTimeInterface
    {
        return $this->delivre_docbth;
    }

    public function setDelivreDocbth(?\DateTimeInterface $delivre_docbth): static
    {
        $this->delivre_docbth = $delivre_docbth;
    ...
    public function removePagebth(Pagebth $pagebth): static
    {
        if ($this->pagebths->removeElement($pagebth)) {
            ...
            if ($pagebth->getCodeDocbth() === $this) {
                $pagebth->setCodeDocbth(null);
            }
        }
