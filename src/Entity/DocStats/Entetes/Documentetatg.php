...
use App\Repository\DocStats\Entetes\DocumentetatgRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Table(name: 'metier.documentetatg')]
#[ORM\Entity(repositoryClass: DocumentetatgRepository::class)]
class Documentetatg
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'documentetatgs')]
    ...
    private ?string $numero_docetatg = null;

    #[ORM\Column(type: Types::DATETIME_MUTABLE, nullable: true)]
    private ?\DateTimeInterface $delivre_docetatg = null;
    ...
    #[ORM\OneToMany(mappedBy: 'code_docetatg', targetEntity: Pageetatg::class)]
    ...
    public function getNumeroDocetatg(): ?string
    {
        return $this->numero_docetatg;
    }

    public function setNumeroDocetatg(string $numero_docetatg): static
    {
        $this->numero_docetatg = $numero_docetatg;

        return $this;
    }

    public function getDelivreDocetatg(): ?\DateTimeInterface
    {
        return $this->delivre_docetatg;
    }

    public function setDelivreDocetatg(?\DateTimeInterface $delivre_docetatg): static
    {
        $this->delivre_docetatg = $delivre_docetatg;
    ...
    public function addPageetatg(Pageetatg $pageetatg): static
    {
        if (!$this->pageetatgs->contains($pageetatg)) {
            ...
            $pageetatg->setCodeDocetatg($this);
        }
    ...
    public function removePageetatg(Pageetatg $pageetatg): static
    {
        if ($this->pageetatgs->removeElement($pageetatg)) {
            ...
            if ($pageetatg->getCodeDocetatg() === $this) {
                $pageetatg->setCodeDocetatg(null);
            }
        }
