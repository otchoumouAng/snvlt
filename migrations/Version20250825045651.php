 ...
 */
final class Version20250825045651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE type_document (id INT NOT NULL, designation VARCHAR(255) NOT NULL, desactivate BOOLEAN NOT NULL, PRIMARY KEY(id))');
